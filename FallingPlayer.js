...
function playerTilt () {
	if (isTiltable == true) {
		...
		tiltAroundZ = FallingLaunch.invertAxesVal * Mathf.Clamp((FallingLaunch.flipMultiplier * (-FallingLaunch.accelerator.y * tiltAngle)), -tiltAngle, tiltAngle);
		tiltAroundX = FallingLaunch.invertAxesVal * Mathf.Clamp((FallingLaunch.flipMultiplier * (-FallingLaunch.accelerator.x * tiltAngle)), -tiltAngle, tiltAngle);
